...
final alarmasProvider = FutureProvider.autoDispose<List<Map<String, dynamic>>>((ref) async {
    ...
    return Scaffold(
      ...
      body: PremiumLockWidget(
        child: alarmasAsync.when(
          ...
          data: (alarmas) => alarmas.isEmpty
              ? _EstadoVacio(onCrear: () => _mostrarDialogoNuevaAlarma(context))
              : _ListaAlarmas(
                  alarmas: alarmas,
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Align(
                ...
                child: Text('Días:', style: TextStyle(fontWeight: FontWeight.w500)),
              ),
              const SizedBox(height: 8),
              Wrap(
                spacing: 6,
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: diasSeleccionados.isEmpty
                  ? null
