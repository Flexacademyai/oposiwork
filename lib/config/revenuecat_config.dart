class RevenueCatConfig {
  ...
  static const String apiKeyIos = String.fromEnvironment('REVENUECAT_API_KEY_IOS');
  static const String apiKeyAndroid = String.fromEnvironment('REVENUECAT_API_KEY_ANDROID');
